...
declare global {
   ...
   * @returns pressed
   */
  function btn(id: number): boolean;
   ...
   */
  function btnp(id: number, hold?: number, period?: number): boolean;

  /**
   * Returns the bitfield of buttons that were pressed the last frame
   */
  function btnp(): number;
   ...
   */
  function clip(x: number, y: number, width: number, height: number): void;
   ...
   */
  function cls(color?: number): void;
   ...
   * @param color the index of the desired color in the current palette
   */
  function circb(x: number, y: number, radius: number, color: number): void;
   ...
   */
  function fget(spriteId: number, flag: number): boolean;
   ...
   */
  function fset(spriteId: number, flag: number, bool: boolean): void;
   ...
   * @returns pressed
   */
  function key(code?: number): boolean;
   ...
   */
  function keyp(code?: number, hold?: number, period?: number): boolean;
   ...
   */
  function memcpy(to: number, from: number, length: number): void;
   ...
   */
  function memset(addr: number, value: number, length: number): void;
   ...
   */
  function mset(x: number, y: number, tileId: number): void;
   ...
   */
  function mouse(): [number, number, boolean, boolean, boolean, number, number];
   ...
   */
  function peek(addr: number, bits?: 1 | 2 | 4 | 8): number;
   ...
   */
  function peek1(addr: number): number;
   ...
   */
  function pix(x: number, y: number, color: number): void;
   ...
   */
  function pix(x: number, y: number): number;
   ...
   */
  function pmem(index: number, val: number): void;
   ...
   */
  function pmem(index: number): number;
   ...
   */
  function poke(addr: number, val: number, bits?: 1 | 2 | 3 | 4): void;
   ...
   */
  function poke1(addr: number, val: number): void;
   ...
   */
  function sync(mask?: number, bank?: number, tocart?: boolean): void;
   ...
   */
  function trace(msg: any, color?: number): void;
